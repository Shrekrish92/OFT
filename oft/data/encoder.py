...
class ObjectEncoder(object):
    ...
    def __init__(self, classnames=['Car'], pos_std=[.5, .36, .5], 
        ...
        '''
        MEAN!!!!
        CAR: [[3.87585958 1.52231074 1.63839347]]
        CYCLE: [[1.75756999 1.74861142 0.61909295]]
        TRAM: [[16.5130662   3.52857143  2.68686411]]
        TRUCK: [[10.83729373  3.16273927  2.56552805]]
        VAN: [[5.02335807 2.22228819 1.89324057]]
        PEDESTRAIN: [[0.86582895 1.75389912 0.69150877]]
        PERSON SITTING: [[0.7136747  1.27349398 0.61222892]]
        MISC: [[4.14476415 2.06108491 1.65779874]]
        DONT CARE: [[-1. -1. -1.]]
        STD!!!!!
        CAR: [[0.41157912 0.13540341 0.09752872]]
        CYCLE: [[0.19341519 0.08501286 0.10081729]]
        TRAM: [[9.67125716 0.20486517 0.1545836 ]]
        TRUCK: [[3.09328837 0.49286703 0.20104505]]
        VAN: [[0.81147166 0.32962464 0.16929228]]
        PEDESTRAIN: [[0.22212593 0.09393269 0.15394663]]
        PERSON SITTING: [[0.1005784  0.11825472 0.07431111]]
        MISC: [[3.26942974 0.90573778 0.68295294]]
        DONT CARE: [[0. 0. 0.]]
        def __init__(self, classnames=['Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting',
                     'Cyclist', 'Tram', 'Misc', 'DontCare'], pos_std=[.5, .36, .5], 
                 log_dim_mean=[[0.42, 0.48, 1.35],[5.02335807, 2.22228819, 1.89324057],[10.83729373, 3.16273927, 2.56552805],[0.86582895, 1.75389912, 0.69150877], [0.7136747, 1.27349398, 0.61222892], [1.75756999, 1.74861142, 0.61909295], [16.5130662, 3.52857143, 2.68686411], [4.14476415, 2.06108491, 1.65779874], [-1., -1., -1.]], 
                 log_dim_std=[[.085, .067, .115], [0.81147166, 0.32962464, 0.16929228], [3.09328837, 0.49286703, 0.20104505], [0.22212593, 0.09393269, 0.15394663], [0.1005784, 0.11825472, 0.07431111], [0.19341519, 0.08501286, 0.10081729], [9.67125716, 0.20486517, 0.1545836 ], [3.26942974, 0.90573778, 0.68295294], [0., 0., 0.]], sigma=1., nms_thresh=0.05):
        '''
...
def non_maximum_suppression(heatmaps, sigma=1.0, thresh=0.285, max_peaks=50):
